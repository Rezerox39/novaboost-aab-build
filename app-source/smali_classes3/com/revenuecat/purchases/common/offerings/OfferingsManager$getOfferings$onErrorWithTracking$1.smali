...
# direct methods
.method public constructor <init>(Lcom/revenuecat/purchases/common/offerings/OfferingsManager;Ljava/util/Date;Ls5/k;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 4
    .line 5
    iput-object p3, p0, Lcom/revenuecat/purchases/common/offerings/OfferingsManager$getOfferings$onErrorWithTracking$1;->$onError:Ls5/k;
...
.method public final invoke(Lcom/revenuecat/purchases/PurchasesError;Lcom/revenuecat/purchases/common/diagnostics/DiagnosticsTracker$CacheStatus;)V
    ...
    .line 3
    iget-object p1, p0, Lcom/revenuecat/purchases/common/offerings/OfferingsManager$getOfferings$onErrorWithTracking$1;->$onError:Ls5/k;

    if-eqz p1, :cond_0

    invoke-interface {p1, v4}, Ls5/k;->invoke(Ljava/lang/Object;)Ljava/lang/Object;

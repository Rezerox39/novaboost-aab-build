...
.method public final b(Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    .line 11
    :cond_0
    invoke-virtual {p0, v0}, Lr/f;->a(Landroid/os/Bundle;)V
...
.method public final c(Landroid/net/Uri;)Landroid/os/Bundle;
    ...
    .line 13
    :cond_0
    iget-object p1, p0, Lr/f;->e:Landroid/app/PendingIntent;
...
.method public g(Landroid/net/Uri;Landroid/os/Bundle;Ljava/util/List;)Z
    ...
    .line 1
    invoke-virtual {p0, p2}, Lr/f;->b(Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    .line 5
    :try_start_0
    iget-object v0, p0, Lr/f;->b:Lb/b;

    .line 6
    .line 7
    iget-object v1, p0, Lr/f;->c:Lb/a;

    .line 8
    .line 9
    invoke-interface {v0, v1, p1, p2, p3}, Lb/b;->j(Lb/a;Landroid/net/Uri;Landroid/os/Bundle;Ljava/util/List;)Z
...
.method public h(Ljava/lang/String;Landroid/os/Bundle;)I
    ...
    .line 8
    :try_start_0
    iget-object v1, p0, Lr/f;->b:Lb/b;

    .line 9
    .line 10
    iget-object v2, p0, Lr/f;->c:Lb/a;

    .line 11
    .line 12
    invoke-interface {v1, v2, p1, p2}, Lb/b;->c(Lb/a;Ljava/lang/String;Landroid/os/Bundle;)I
...
.method public i(Landroid/net/Uri;)Z
    ...
    .line 7
    invoke-virtual {p0, p1, v1, v0}, Lr/f;->j(Landroid/net/Uri;Landroid/net/Uri;Landroid/os/Bundle;)Z
...
.method public j(Landroid/net/Uri;Landroid/net/Uri;Landroid/os/Bundle;)Z
    ...
    .line 1
    :try_start_0
    invoke-virtual {p0, p2}, Lr/f;->c(Landroid/net/Uri;)Landroid/os/Bundle;
    ...
    .line 13
    .line 14
    invoke-interface {p2, v0, p1, p3}, Lb/b;->a(Lb/a;Landroid/net/Uri;Landroid/os/Bundle;)Z
    ...
    .line 20
    .line 21
    iget-object p3, p0, Lr/f;->c:Lb/a;

    .line 22
    .line 23
    invoke-interface {p2, p3, p1}, Lb/b;->q(Lb/a;Landroid/net/Uri;)Z
...
.method public k(ILandroid/net/Uri;Landroid/os/Bundle;)Z
    ...
    .line 9
    :cond_0
    invoke-virtual {p0, p3}, Lr/f;->b(Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    .line 16
    .line 17
    invoke-interface {v0, v2, p1, p2, p3}, Lb/b;->v(Lb/a;ILandroid/net/Uri;Landroid/os/Bundle;)Z

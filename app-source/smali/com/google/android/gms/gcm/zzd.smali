...
.method public final zze(Landroid/os/Bundle;)Z
    ...
    .line 44
    invoke-static {v7, v8}, Lcom/google/android/gms/ads/internal/util/d;->a(Landroid/app/NotificationManager;Ljava/lang/String;)Landroid/app/NotificationChannel;
    ...
    .line 54
    invoke-static {}, Lcom/google/android/gms/ads/internal/util/f;->a()V
    ...
    invoke-static {v8, v9, v10}, Lp3/c;->a(Ljava/lang/String;Ljava/lang/CharSequence;I)Landroid/app/NotificationChannel;

    move-result-object v9

    .line 56
    invoke-static {v7, v9}, Lp3/b;->a(Landroid/app/NotificationManager;Landroid/app/NotificationChannel;)V
    ...
    :cond_13
    :goto_7
    new-instance v8, Ld0/m$e;

    iget-object v9, p0, Lcom/google/android/gms/gcm/zzd;->zzl:Landroid/content/Context;

    invoke-direct {v8, v9}, Ld0/m$e;-><init>(Landroid/content/Context;)V

    const/4 v9, 0x1

    .line 59
    invoke-virtual {v8, v9}, Ld0/m$e;->e(Z)Ld0/m$e;

    move-result-object v8

    invoke-virtual {v8, v5}, Ld0/m$e;->p(I)Ld0/m$e;
    ...
    .line 61
    invoke-virtual {v5, v0}, Ld0/m$e;->j(Ljava/lang/CharSequence;)Ld0/m$e;
    ...
    .line 63
    invoke-virtual {v5, v1}, Ld0/m$e;->i(Ljava/lang/CharSequence;)Ld0/m$e;
    ...
    invoke-virtual {v0, v1}, Ld0/m$c;->h(Ljava/lang/CharSequence;)Ld0/m$c;

    move-result-object v0

    invoke-virtual {v5, v0}, Ld0/m$e;->r(Ld0/m$f;)Ld0/m$e;
    ...
    invoke-virtual {v5, v0}, Ld0/m$e;->g(I)Ld0/m$e;

    :cond_16
    if-eqz v3, :cond_17

    .line 67
    invoke-virtual {v5, v3}, Ld0/m$e;->q(Landroid/net/Uri;)Ld0/m$e;

    :cond_17
    if-eqz v6, :cond_18

    .line 68
    invoke-virtual {v5, v6}, Ld0/m$e;->h(Landroid/app/PendingIntent;)Ld0/m$e;

    :cond_18
    if-eqz v7, :cond_19

    .line 69
    invoke-virtual {v5, v7}, Ld0/m$e;->f(Ljava/lang/String;)Ld0/m$e;
